...
extern "C" {
    #[doc = "Fetch the internal arrow schema from result.\n\n result: The result to fetch the schema from.\n out_schema: The output schema."]
    pub fn duckdb_result_arrow_schema(result: duckdb_result, out_schema: *mut duckdb_arrow_schema);
}
extern "C" {
    #[doc = "Get a datachunk content as arrow array.\n\n chunk: The data chunk to fetch the array from.\n out_array: The output array."]
    pub fn duckdb_data_chunk_arrow_array(chunk: duckdb_data_chunk, out_array: *mut duckdb_arrow_array);
}
extern "C" {
    #[doc = " TODO"]
    pub fn duckdb_stream_fetch_arrow(result: duckdb_result, out_array: *mut duckdb_arrow_array);
}
extern "C" {
